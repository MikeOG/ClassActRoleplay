...
async function OnLoginRequest(elem) {
    ...
    $.post("http://Roleplaymain/Login.LoadCharacters", JSON.stringify({}));
}
...
async function OnDoLogin(elem) {
    ...
    $.post("http://Roleplaymain/Login.SelectChar", JSON.stringify({
...
async function OnCreateCharacter() {
    ...
    $.post("http://Roleplaymain/Login.CreateCharacter", JSON.stringify({
        firstName: firstName,
        lastName: lastName,
        DOB: dob
    }));
...
async function OnCharacterDelete(charId) {
    ...
    $.post("http://Roleplaymain/Login.DeleteChar", JSON.stringify({
        charId: charId
    }));
}
...
window.addEventListener("DOMContentLoaded", function() {
    $.get("https://api.Roleplayrp.com/fivem/patchnotes.php", function(data) {
